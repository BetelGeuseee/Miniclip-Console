...
{
	PlaySound(TEXT("C:\\Users\\DELL\\Desktop\\essentials\\applaud2.wav"),NULL,SND_SYNC);
}
void kbc :: sound(void)
{
	PlaySound(TEXT("C:\\Users\\DELL\\Desktop\\essentials\\kbc.wav"),NULL,SND_SYNC);
}
void kbc :: buzzer(void)
{
	PlaySound(TEXT("C:\\Users\\DELL\\Desktop\\essentials\\buzzer.wav"),NULL,SND_SYNC);
}
void kbc :: congratulation(void)
{
	PlaySound(TEXT("C:\\Users\\DELL\\Desktop\\essentials\\congrats.wav"),NULL,SND_ASYNC);
}
